...
export const presentation = {
    en: {
        ...
        intro1: 'My name is Florian SACCHETTI, I am a 26 years-old French people born in Lyon, France',
        intro2: 'Currently living in Korea, I am looking for a job in the Energy and Environment field'
    },
    fr: {
        presTitle: 'Présentation',
        src: [flophoto1, flophoto2, flophoto3],
        name: 'Florian Sacchetti',
        intro1: "Je m'appelle Florian SACCHETTI, j'ai 26 ans et je suis né à Lyon en France",
        intro2: "Je vis actuellement en Corée du Sud et je recherche un emploi dans le secteur de l'énergie et/ou l'environement"
    },
    kr: {
        presTitle: '자기 소개',
        src: [flophoto1, flophoto2, flophoto3],
        ...
        intro2: '현재 한국에서 살고 있으며 환경/에너지 분야에서 취직을 하고자 합니다'
    }
}
...
export const schoolDetails = {
    ...
    utbmimg: utbmlogo,
    lyonimg: lyonlogo,
    enjbnu: ['2021-2023', 'Jeonbuk National University - South Korea', `Environment and Energy Department (Master's Degree)`, 'Carbon Dioxyde Storage', 'Reservoir Simulation', 'Carbon Neutral', 'Basics of coding (Python, Matlab, HTML/CSS, JavaScript)', 'Professor: Youngsoo Lee'],

    frjbnu: ['2021-2023', 'Université Nationale Jeonbuk - Corée du Sud', 'Département Energie et Environement (Master)', 'Stockage de dioxide de carbon', 'Simulation de reservoir', 'Neutralité carbone', 'Base de la programmation (Python, Matlab, HTML/CSS, JavaScript)', 'Professeur tuteur: Youngsoo Lee'],

    krjbnu: ['2021-2023', '전북대학교 - 대한민국', `환경에너지융합학과 (석사)`, '이산화탄소지중저장', '저류층 시뮬레이션', '탄소중립', '코딩 (Python, Matlab, HTML/CSS, JavaScript)', '지도 교수: 이영수 교수'],

    enjbnuExchange: ['2019-2021', 'Jeonbuk National University - South Korea', `Exchange Program`, 'Korean Language'],

    frjbnuExchange: ['2019-2021', 'Université Nationale Jeonbuk - Corée du Sud', `Programme d'échange`, 'Etude de la langue coréenne'],

    krjbnuExchange: ['2019-2021', '전북대학교 - 대한민국', `교환 학생`, '한국어학당'],

    enutbm: ['2017-2021', 'University of Technology of Belfort-Montbeliard - France', `Electrical Engineering (Master's Degree)`, 'Power Electronics', 'Electric Power Quality', 'Renewable Energies'],

    frutbm: ['2017-2021', 'Université de Technologie de Belfort-Montbeliard - France', `Energie (Diplome d'ingénieur)`, `Electronique de puissance`, `Qualité de l'énergie`, 'Energie renouvelable'],

    krutbm: ['2017-2021', 'UTBM, 벨포르 프랑스', '에너지공학과 (석사) ', '전력 전자', '전력 품질', '재생 에너지'],

    enlyon: ['2015-2017', 'University Claude Bernard Lyon 1 - France', `Maintenance Engineering (Undergraduate Degree)`, 'Electricity, Electronic, Thermodynamic and Mechanic engineering basics'],

    frlyon: ['2015-2017', 'Université Claude Bernard Lyon 1 - France', `Génie Industriel et Maintenance (Diplome Universitaire de Technologie)`, `Etude de l'électricité, électronique, thermodynamique et mécanique`],

    krlyon: ['2015-2017', '끌로드 베흐노 리용 1 대학', '산업-유지관리공학 (전문학사)', '전기, 전자, 연역학, 기계력학 기초 교육'],
}
...
export const workDetails = {
    ...
    suezimage: suezlogo,
    enedf: ['2018-2019', 'EDF (French Electricity Produer) - Nuclear Power Plant, Bugey, France', 'Six-month Internship', 'Electrical Research and Development Department', 'Propositon of modification on the lubrication shaft system by electric panel'],
    fredf: ['2018-2019', 'EDF (Electricité de France) - Centrale nucléaire du Bugey, France', 'Stage de six mois', `Département électrique`, `Proposition de modification du système de lubrification de l'arbre de transmission par distributeur électrique`],
    kredf: ['2018-2019', 'EDF (프랑스 전력공사) - 원자력 발전소, Bugey, 프랑스', '인턴십 (6개월)', '전기 개발 부서', ' 배전반을 통해서 구동축의 윤활방식 변경 제안'],

    enenedis: ['2017', 'ENEDIS (French Operator of Electricity Distribution Grid) - Design Office, Lyon, France', 'Three-month Intership', 'Analysis of damage on electrical substation with different flood scenario'],
    frenedis: ['2017', `ENEDIS (Distributeur d'électricité) - Bureau d'office, Lyon, France`, 'Stage de trois mois', `Analyse des dommages causés par les différents scénarios d'inondation sur les postes électriques`],
    krenedis: ['2017', 'ENEDIS (프랑스 배전공사) - 개발부서, 리옹, 프랑스', '인턴십 (3개월)', '홍수 시나리오에 따른 발전소 훼손 평가'],

    ensuez: ['2017, 2018', 'Suez Environment - Waste Management Office, Lyon, France', 'Part-time Job', 'Administrative work',],
    frsuez: ['2017, 2018', `Suez Environment - Bureau de gestion des déchets, Lyon, France`, 'Part-time Job', 'Travail administratif'],
    krsuez: ['2017, 2018', '수에즈 인바이론먼트 - 폐기물 처리 사무실, 리옹, 프랑스', '알바', '사무실 근무']
}
...
export const projectDetails = {
    ...
    krproj1: [
      "수압 파쇄 수평정을 이용한 저류층에서의 이산화탄소 지중저장 시뮬레이션 연구 (학위논문)", `수압 파쇄로 처리된 수평정을 통해서 CO2 주입으로 지중저장 타당성 연구`, `지상 누출 및 저류층 내의 CO2 확산 분석평가`, `CO2 저장에 대한 트랩 메커니즘의 영향`
    ],
    foldfrproj1: ["En savoir plus", "En savoir moins"],
    foldenproj1: [`Learn more`, "Learn less"],
    foldkrproj1: ["자세히 보기", "접기"],
    abstractfrproj1: ["Extrait (anglais)", `The excessive utilization of fossil fuels led to significant emissions of greenhouse gases, increasing the atmospheric carbon dioxide (CO2) concentration to alarming levels and contributing to global warming and climate change.`,
...
export const footerInfo = {
    enfooter: ['Contact', 'E-mail:', 'florian.sacchetti@gmail.com', 'Phone:', '+82 (0)10-8391-7997', 'Kakao:', 'Instagram:'],
    frfooter: ['Contact', 'E-mail :', 'florian.sacchetti@gmail.com', 'Telephone :', '+82 (0)10-8391-7997', 'Kakao :','Instagram :'],
    krfooter: ['연락처', '이메일:', 'florian.sacchetti@gmail.com', '전화번화:', '010-8391-7997', '카카오:', '인스타그램:'],
    kakaoImg: kakaoQr,
    instaImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Instagram_logo_2022.svg/225px-Instagram_logo_2022.svg.png',
    enAppear: ['Scan the QR code to add my Kakao profil. ', 'Click on it to go back'],
    frAppear: ['Scannez le QR code pour ajouter mon profil Kakao. ', 'Cliquez dessus pour revenir en arrière'],
    krAppear: ['QR 코드를 통해서 카카오 프로필을 추가하세요. ', 'QR 코드를 클릭하여 뒤로 돌아오기'],
