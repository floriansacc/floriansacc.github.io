  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-around sm:flex-col sm:px-2 md:mt-4 md:items-center">
        <div className="mb-10 flex flex-col items-start justify-center gap-4 px-10 break-keep sm:items-center sm:gap-0 sm:px-2 md:flex-wrap lg:w-[65%]">
        ...
        <div className="flex items-center justify-center lg:w-[35%]">
          ...
          >
            <div className="gradient-border-center bottom absolute inset-0 h-px"></div>
            <img
              src="/assets/allowed/images/profile_picture.jpeg"
              className={`border-line/50 sticky top-0 left-0 rounded-xl border-2 border-solid sm:translate-x-0 sm:translate-y-0 sm:border-0`}
              style={{
      ...
      <div className="flex w-full justify-between sm:flex-col md:mt-6 md:flex-wrap lg:mt-10">
        <div className="flex w-full flex-col items-start justify-start gap-4 p-2 px-10 sm:w-full sm:flex-col sm:items-center sm:px-2 md:mt-5 md:w-full lg:w-[65%]">
          <div className="relative mb-10 flex flex-col items-start justify-center gap-4 py-4 pr-8 pl-2 text-2xl font-normal sm:w-full sm:px-0 sm:text-xl md:text-xl lg:w-full">
            <div className="gradient-border-center absolute inset-0 -top-1 h-px"></div>
            <span>
