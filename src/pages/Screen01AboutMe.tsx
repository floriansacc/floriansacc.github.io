  ...
  return (
    ...
    >
      <div className="mb-10 flex w-full items-center justify-around sm:flex-col md:items-start">
        ...
        <div className="relative min-w-[200px] rounded-xl border-2 border-solid border-line bg-cover sm:w-[60%] md:w-80 lg:m-2 lg:w-80">
          <img
      ...
      <div className="flex items-start justify-start gap-4 p-2 sm:w-full sm:flex-col-reverse sm:items-center md:w-[80%] lg:w-[80%]">
        <div className="flex flex-col sm:w-full md:mt-5 md:w-fit lg:w-full">
          <div className="mb-10 flex flex-col items-start justify-center gap-4 border-t border-solid border-line/50 py-4 pl-2 pr-8 text-2xl font-normal sm:w-full sm:px-2 lg:w-8/12">
            <p>
          ...
          <div className="flex flex-col items-start justify-center gap-4 border-t border-solid border-line/50 py-4 pl-2 pr-8 text-2xl font-normal sm:w-full sm:px-2 lg:w-8/12">
            <p>
