...
import Section0Intro from "@/pages/sections/Section0Intro.vue";
import Section1About from "@/pages/sections/Section1About.vue";
...
import useScrollIndex from "@/composables/useScrollIndex";
